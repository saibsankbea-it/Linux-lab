...
- J'ai appris les bases de l'administration Linux.
- Je sais naviguer dans l'arborescence avec pwd, cd et ls, créer et gérer des fichiers avec mkdir, touch, cp, mv et rm. - J'ai également étudié les permissions Linux avec chmod et chown, ainsi que la gestion des utilisateurs.
- Ensuite, j'ai découvert SSH pour l'administration à distance et j'ai généré une paire de clés SSH Ed25519 afin de comprendre l'authentification par clé publique et clé privée.
